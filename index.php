                ...
                <div class="list-group-item" style="background-color: #eaeef3">
                        ...
                        <div class="table-responsive">
							<table class="table table-hover">
								...
								<tbody>
									<?php foreach($contas->listAccounts() as $accounts): ?>
									<tr class="tr">
										<td><?php echo $accounts['id'] ?></td>
										<td><?php echo $accounts['titular'] ?></td>
										<td><?php echo $accounts['agencia'] ?></td>
										<td><?php echo $accounts['conta'] ?></td>
										<td><?php echo $accounts['saldo'] ?></td>
